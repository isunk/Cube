...
type DatabaseTransaction = {
     ...
     */
    exec(stmt: string, ...params: any[]): DatabaseResult;
    /**
...
type CipherAlgorithm = "aes-ecb" | "aes-cbc" | "aes-gcm" | "sm4-ecb" | "sm4-cbc"
type CipherOptions = {
    padding?: "none" | "pkcs5" | "pkcs7" | "zero";
    iv?: GenericByteArray;
    nonce?: GenericByteArray;
}
declare function $native(name: "crypto"): {
    /**
     * create cipher for encryption and decryption
     * 
     * @param algorithm algorithm, e.g. "aes-ecb", "aes-cbc", "sm4-ecb", "sm4-cbc"
     * @return cipher object
     */
    createCipher(algorithm: CipherAlgorithm): {
        /**
         * encrypt input data
         * 
         * @param input input data
     ...
     * @return hash object
     */
    createHash(algorithm: HashAlgorithm | "sm3"): {
        /**
         * sum input data
         * 
         * @param input input data
     ...
     * @return HMAC object
     */
    createHmac(algorithm: HashAlgorithm | "sm3"): {
        /**
     ...
     * create RSA client
     * 
     * @return RSA client object
     */
    createRsa(): {
        /**
         * generate RSA key pair
         * 
         * @return key pair with private key(PKCS#1) and public key(PKCS#1)
         */
         ...
         * 
         * @param input input data
         * @param publicKey public key(PKCS#1)
         ...
         * 
         * @param input input data
         * @param privateKey private key(PKCS#1)
         * @param padding padding scheme
         * @return decrypted data
         */
         ...
         * @return signature
         */
        sign(input: GenericByteArray, privateKey: GenericByteArray, algorithm: HashAlgorithm, padding: "pkcs1" | "pss" = "pkcs1"): Buffer;
        /**
         ...
         */
        verify(input: GenericByteArray, sign: GenericByteArray, publicKey: GenericByteArray, algorithm: HashAlgorithm, padding: "pkcs1" | "pss" = "pkcs1"): boolean;
    };
    /**
     * create SM2 client
     * 
     * @return SM2 client object
     */
    createSm2(): {
        /**
